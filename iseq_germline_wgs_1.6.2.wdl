...
import "https://gitlab.com/intelliseq/workflows/raw/panel-generate@1.6.3/src/main/wdl/tasks/panel-generate/panel-generate.wdl" as panel_generate_task
...
import "https://gitlab.com/intelliseq/workflows/raw/fq-qc@1.3.1/src/main/wdl/modules/fq-qc/fq-qc.wdl" as fq_qc_module
import "https://gitlab.com/intelliseq/workflows/raw/fq-bwa-align@1.4.0/src/main/wdl/modules/fq-bwa-align/latest/fq-bwa-align.wdl" as fq_bwa_align_module
...
workflow germline {
    ...
    meta {
        ...
        variant1_input_genes: '{"index": 5, "name": "Genes names", "type": "String", "groupname": "gene_panel", "description": "Enter gene names to narrow your search/analysis results (separate gene names with non-alphanumeric characters, for example: HTT, FBN1)"}'
        ...
        variant2_input_genes: '{"index": 5, "name": "Genes names", "type": "String", "groupname": "gene_panel", "default": "GNE", "description": "Enter gene names to narrow your search/analysis results (separate gene names with non-alphanumeric characters, for example: HTT, FBN1)"}'
        ...
        variant3_input_genes: '{"index": 5, "name": "Genes names", "type": "String", "groupname": "gene_panel", "description": "Enter gene names to narrow your search/analysis results (separate gene names with non-alphanumeric characters, for example: HTT, FBN1)"}'
        ...
        variant4_input_genes: '{"index": 5, "name": "Genes names", "type": "String", "groupname": "gene_panel", "default": "GNE", "description": "Enter gene names to narrow your search/analysis results (separate gene names with non-alphanumeric characters, for example: HTT, FBN1)"}'
        ...
        input_hpo_terms: '{"index": 3, "name": "HPO terms", "type": "String", "groupname": "gene_panel", "description": "Enter HPO terms to narrow your search/analysis results (separate HPO terms with non-alphanumeric characters, for example: HP:0004942, HP:0011675)"}'
